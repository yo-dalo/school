...
require("./header.php");
  ...
  <div class="container">
    ...
    <?php $page = getSingle($con, "SELECT * FROM Facility WHERE Id = {$id}"); //print_r($news) ?>
    ...
    <div class="news-image"><img src="http://0.0.0.0:8080/x/uploads/<?php echo htmlspecialchars($page['Image']); ?>" alt="" /></div>
