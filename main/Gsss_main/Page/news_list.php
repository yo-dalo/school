...
<?php $newses = getAll($con, "SELECT * FROM Notification ORDER BY Id DESC LIMIT $startFrom, $limit"); //print_r($facilities) ?>

<?php foreach ($newses as $newses): ?>
   <a href="news_detail.php?id=<?php echo($newses['Id'] ?? '0'); ?>"><div class="news-item">
