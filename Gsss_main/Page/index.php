...
<img src="http://0.0.0.0:8080/x/uploads/<?php echo htmlspecialchars($facility['Image']); ?>" alt="" />
</div>
...
<a href="<?php echo htmlspecialchars($aom['Read_More_Url'] ?? 'No name'); ?>"><button>Admissions Open</button></a>
  ...
  <section class="admission-open" style="padding:32px;  border-radius:12px; max-width:900px; margin:20px auto; font-family:Arial, sans-serif; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
  <div style="display:flex; align-items:center; gap:20px; flex-wrap:wrap;">
    <div style="flex:1; min-width:220px;">
      <h2 style="margin:0 0 8px 0; font-size:28px; letter-spacing:0.4px; color:#064e3b;">Addmission Open</h2>
      <p style="margin:0 0 16px 0; font-size:10px; color:#065f46; opacity:0.9;">
        Enrollment for the new session is now open. Secure your seat — limited availability.
...
<?php foreach ($newses as $news):  ?>
   ...
   <li style="background:#ffffff; padding:14px 18px;margin:2vw 0; border-left:5px solid #1e3a8a; border-radius:6px; box-shadow:0 2px 6px rgba(0,0,0,0.05);">
...
<div class="facility-Img">
<img src="http://0.0.0.0:8080/x/uploads/<?php echo htmlspecialchars($achiev['Image'] ?? 'No name'); ?>" alt="" />
</div>
